...
namespace Antmicro.Renode.Peripherals.GPIOPort
{
    ...
    public class XMC4500GPIOPort : BaseGPIOPort, IDoubleWordPeripheral
    {
        public XMC4500GPIOPort(Machine machine, uint modeResetValue = 0, uint outputSpeedResetValue = 0, uint pullUpPullDownResetValue = 0) : base(machine, 16)
        {
